...
Provide tooltip overlays on UI controls that have keyboard shortcuts, enabling users to discover key bindings by hovering over the control, implemented as Angular component templates.
