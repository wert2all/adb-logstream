...
Define global keyboard shortcuts for the Client to enable quick access to search, level toggling, and log clearing without using the mouse, implemented via Angular `@HostListener`.
