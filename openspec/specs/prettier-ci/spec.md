...
Ensure all code in the repository follows consistent Prettier formatting rules through automated CI checks on `main` and pull requests, with a matching local `format` script for developer convenience.
