...
Defines the requirements for the Prettier CI linting capability — a GitHub Actions workflow and local tooling that enforces consistent code formatting across the project.
