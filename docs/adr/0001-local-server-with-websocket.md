...
**Consequences:** The server must be running on the same machine as the `adb` daemon. Cross-device logstream viewing requires SSH tunneling or a similar proxy.
